...
public class CubeDroneTest {
	...
	@Test
	public void testDroneMoveDownHitObstacleTryToGetAround(){
		obstacles = new ArrayList<>();
		Cube outerCube = new Cube(new int[] {0,0,0},50);
		Cube innerCube = new Cube(new int[] {10,10,10},30);
		Cube expectedDronePosition = new Cube(new int[] {29,5,30},1);
		obstacles.add(new Cube(new int[]{30,2,30},5));
		drone = new CubeDrone(outerCube, innerCube, new int[] {30,6,30},1,obstacles);
		String expectedResponse = expectedDronePosition.toString();
		
		assertEquals(expectedResponse, drone.moveDown());
	}
	@Test
	public void testDroneMoveRightHitObstacleTryToGetAround(){
		obstacles = new ArrayList<>();
		Cube outerCube = new Cube(new int[] {0,0,0},50);
		Cube innerCube = new Cube(new int[] {10,10,10},30);
		Cube expectedDronePosition = new Cube(new int[] {29,1,30},1);
		obstacles.add(new Cube(new int[]{30,2,30},5));
		drone = new CubeDrone(outerCube, innerCube, new int[] {30,1,30},1,obstacles); //trenutna pozicija
		String expectedResponse = expectedDronePosition.toString();
	...
	public void testInitialMoveRight(){
		...
		Cube innerCube = new Cube(new int[] {10,10,10},30);
		Cube testDrone = new Cube(new int[] {30,5,30},1);
		Cube expectedDronePosition = new Cube(new int[]{31,5,30},1);
		drone = new CubeDrone(outerCube, innerCube, new int[] {30,5,30},1);
		String expectedResponse = expectedDronePosition.toString();
	...
	public void testInitialMoveForth(){
		Cube outerCube = new Cube(new int[]{0,0,0},50);
		Cube innerCube = new Cube(new int[]{10,10,10},30);
		Cube testDrone = new Cube(new int[]{30,5,31},1);
		Cube expectedDronePosition = new Cube(new int[]{30,5,30},1);
		drone = new CubeDrone(outerCube, innerCube, new int[]{30,5,31},1);
		String expectedResponse = expectedDronePosition.toString();
	...
	public void testInitialMoveBack(){
		...
		Cube innerCube = new Cube(new int[]{10,10,10},30);
		Cube testDrone = new Cube(new int[]{30,5,31},1);
		Cube expectedDronePosition = new Cube(new int[]{30,5,32},1);
		drone = new CubeDrone(outerCube, innerCube, new int[]{30,5,31},1);
		String expectedResponse = expectedDronePosition.toString();
